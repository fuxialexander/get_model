...
DATA_DIR=/pmglocal/ty2514/GET_STARTED/get_data
...
DATE=`date +%Y%m%d`
OUTPUT_DIR="/pmglocal/ty2514/get_checkpoints/Expression_Finetune_K562_HSC.Chr4&14.conv50.atac_loss.nofreeze.nodepth.gap50.shift10.R100L500.augmented.${DATE}/"
