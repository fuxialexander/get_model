...
mamba activate /pmglocal/ty2514/GET_STARTED/mambaforge/get_started
# Set the path to save checkpoints
DATE=`date +%Y%m%d`
OUTPUT_DIR="/pmglocal/ty2514/MotifVAE_with_kl_loss_Embedding_Finetune_monocyte.Chr4&14.conv50.atac_loss.autoencoder.shift10.R100L1000.augmented.20240315/"
...
OMP_NUM_THREADS=1 torchrun --nproc_per_node=6 --rdzv-endpoint=localhost:$PORT get_model/finetune.py \
    ...
    --output_dim 2 \
    --num_motif 637 \
    --model get_finetune_motif_vae \
    --batch_size 32 \
    --num_workers 32 \
    --n_peaks_lower_bound 2 \
    --n_peaks_upper_bound 1 \
    --center_expand_target 540 \
    --preload_count 200 \
    --random_shift_peak \
    --pin_mem \
