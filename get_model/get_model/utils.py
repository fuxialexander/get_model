...
def frange_cycle_linear(n_iter, start=0.0, stop=1.0,  n_cycle=6, ratio=0.7):
    """An cyclic annealing schedular
    Input: number of epoch
    Output: a float represents the beta term of KL loss during Motf-VAE training"""
