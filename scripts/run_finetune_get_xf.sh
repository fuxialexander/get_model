...
OUTPUT_DIR='/pmglocal/xf2217/20240213.finetune_from_175_conv50_non_redundant_depth1024_500_region_200bp/'
...
OMP_NUM_THREADS=1 torchrun --nproc_per_node=8 --rdzv-endpoint=localhost:$PORT get_model/finetune.py \
    ...
    --wandb_run_name "20240213.finetune_from_175_conv50_non_redundant_depth1024_500_region_200bp" \
    --eval_freq 2 \
    --dist_eval \
    --eval_nonzero \
